...
Unlike most projects, development for this repository is carried out on the **4.7.x branch**. This is because the master branch contains the latest stable release of the project. The code in 4.7.x is merged to the master branch after a final review and a round of testing.

Please follow these guidelines when contributing to the code:
1. Fork the current repository.
2. Create a topic branch from the 4.7.x branch.
...
git fetch upstream
git checkout -b <topic-branch> upstream/4.7.x
