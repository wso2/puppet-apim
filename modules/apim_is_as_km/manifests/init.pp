...
# Class: apim_is_as_km
# Init class of API Manager - IS as Key Manager profile
class apim_is_as_km inherits apim_is_as_km::params {
  ...
  /*
    ...
    Note: Ensure that file is available in modules -> apim_is_as_km -> files
  */
