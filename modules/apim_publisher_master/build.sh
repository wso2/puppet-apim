...
puppet apply -e "include apim_publisher_master" --modulepath=${puppet_env}/modules
...
copy_to_agent() {
  ...
  cp ${product_binary} ${puppet_env}/modules/apim_publisher/files/
}
...
then
  ...
  while read -r line; do
    ...
    template_file=${puppet_env}/modules/apim_publisher_master/templates/carbon-home/${filepath}.erb
    if [[ -f ${template_file} ]]
    then
